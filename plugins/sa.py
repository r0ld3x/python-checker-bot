...
headers = {
    "authority": "glen-craigcaninetraining.co.uk",
    ...
    "origin": "https://glen-craigcaninetraining.co.uk",
    "referer": "https://glen-craigcaninetraining.co.uk/membership-account/membership-checkout/",
    "user-agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36"}




@Client.on_message(filters.command(["sa"], prefixes=[".", "/", "!"], case_sensitive=False) & filters.text)
